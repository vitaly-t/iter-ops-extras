...
* [removeNotType](./src/remove-type.ts) - removes values that are not of specific primitive type(s).
* [removeType](./src/remove-type.ts) - removes values of specific primitive type(s).
